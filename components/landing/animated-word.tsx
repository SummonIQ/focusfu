      ...
      {Array.from(text).map((char, i) => (
        <span
          ...
          style={{
            ...
            transform: /[gjpqy]/.test(char) ? 'translateX(1px)' : undefined,
          }}
        >
          {char}
        </span>
        ...
        <AnimatePresence mode="wait" initial={false}>
          <motion.span
            ...
            style={{
              ...
              transform: `translateX(14px) translateY(calc(-50% + ${shadowBaseOffset} + var(--shadow-rise, 0px))) scaleY(1.08) skewX(-16deg)`,
