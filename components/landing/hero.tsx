      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.45fr)] gap-10 lg:gap-12 items-start">
          ...
          <div className="relative z-0">
            <div className="absolute -inset-10 rounded-[2.5rem] bg-gradient-to-br from-brand-400/25 via-accent-400/20 to-brand-500/10 blur-3xl -z-10 transition-[filter] duration-700 ease-out" style={{ filter: `blur(64px) hue-rotate(${activeIndex * 40}deg)` }} />
